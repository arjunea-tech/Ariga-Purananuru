...
@Component({
  selector: 'app-yappu-seer-p2n',
  standalone: true,
  imports: [],
  templateUrl: './yappu-seer-p2n.html',
  styleUrls: ['./yappu-seer-p2n.css']
})
export class YappuSeerP2nComponent implements OnInit, OnChanges, OnDestroy {
  @Input() activity: any;
