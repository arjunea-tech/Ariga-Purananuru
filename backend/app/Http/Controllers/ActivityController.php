...
class ActivityController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'type' => 'required|string|in:custom,mcq,fill_blanks,match,crossword,word_arrange,speaking,role_play,sequencing,parts_of_speech,mind_map,writing,odd_one_out,word_hunt,letter_basket,word_builder',
