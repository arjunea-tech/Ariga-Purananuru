  ...
  [
    ...
    [
      ...
      [
        ...
        'reading_pages' => [
          '<h2 class="text-primary text-center mb-4">எழுத்து</h2><p>அசைக்கு அடிப்படை உறுப்பாக எழுத்து அமைகிறது. "எழுதப்படுதலின் எழுத்தே" என்று இலக்கண விளக்கம் எழுத்தினைக் குறிப்பிடுகிறது. ஒலியினை வடிவமாக்கிக் காட்ட உதவுவதே எழுத்து ஆகும்.</p><p>ஒலியின் அளவினைத் தமிழ் மொழியில் மாத்திரை என்று குறிப்பிடுவர். மாத்திரை என்பது மனிதன் இயல்பாகக் கண்ணிமைக்கும் நொடி அல்லது கை நொடிக்கும் நொடி ஆகும். ஒரு முறை கண்ணிமைக்கும் நேரம் அல்லது ஒரு முறை கை நொடிக்கும் நேரம் ஒரு மாத்திரை ஆகும்.</p>',
          '<h2 class="text-primary text-center mb-4">எழுத்தின் வகைகள்</h2><p>எழுத்துக்களின் வகைகளை மூன்றாகப் பிரித்து அறிந்து கொள்வது அசை பிரிக்க அடிப்படையான தகுதி ஆகும்.<br>1. குறில்<br>2. நெடில்<br>3. மெய் / ஒற்று</p><h4>1. குறில்</h4><p>ஒரு மாத்திரை அளவுடைய எழுத்துக்கள் குறில் எழுத்துக்கள் ஆகும். அ இ உ எ ஒ ஆகிய ஐந்து உயிர் எழுத்துக்களும் உயிர்க்குறில் ஆகும். மெய் எழுத்துக்கள் பதினெட்டும் இந்த உயிர் எழுத்துக்களுடன் கூடி உயிர்மெய்க்குறில் எழுத்துக்கள் உருவாகும்.</p>',
          '<h2 class="text-primary text-center mb-4">உயிர்மெய் குறில்</h2><div class="table-responsive"><table class="table table-bordered text-center align-middle" style="font-size: 0.9rem;">
            <thead class="bg-light"><tr><th></th><th>அ</th><th>இ</th><th>உ</th><th>எ</th><th>ஒ</th></tr></thead>
            <tbody>
          ...
          '<h2 class="text-primary text-center mb-4">உயிர்மெய் குறில் (தொடர்ச்சி)</h2><div class="table-responsive"><table class="table table-bordered text-center align-middle" style="font-size: 0.9rem;">
            <thead class="bg-light"><tr><th></th><th>அ</th><th>இ</th><th>உ</th><th>எ</th><th>ஒ</th></tr></thead>
            <tbody>
          ...
          '<h2 class="text-primary text-center mb-4">2. நெடில்</h2><p>இரண்டு மாத்திரை அளவுடைய எழுத்துக்கள் நெடில் எழுத்துக்கள் ஆகும். ஆ ஈ ஊ ஏ ஐ ஓ ஔ ஆகிய ஏழு உயிர் எழுத்துக்களும் உயிர்நெடில் ஆகும். மெய் எழுத்துக்கள் பதினெட்டும் இந்த உயிர் எழுத்துக்களுடன் கூடி இந்த உயிர்மெய்நெடில் எழுத்துக்கள் உருவாகும்.</p>',
          '<h2 class="text-primary text-center mb-4">உயிர்மெய் நெடில்</h2><div class="table-responsive"><table class="table table-bordered text-center align-middle" style="font-size: 0.8rem;">
            <thead class="bg-light"><tr><th></th><th>ஆ</th><th>ஈ</th><th>ஊ</th><th>ஏ</th><th>ஐ</th><th>ஓ</th><th>ஔ</th></tr></thead>
            <tbody>
          ...
          '<h2 class="text-primary text-center mb-4">உயிர்மெய் நெடில் (தொடர்ச்சி)</h2><div class="table-responsive"><table class="table table-bordered text-center align-middle" style="font-size: 0.8rem;">
            <thead class="bg-light"><tr><th></th><th>ஆ</th><th>ஈ</th><th>ஊ</th><th>ஏ</th><th>ஐ</th><th>ஓ</th><th>ஔ</th></tr></thead>
            <tbody>
          ...
          '<h2 class="text-primary text-center mb-4">3. மெய்</h2><p>க் ங் ச் ஞ் ட் ண் த் ந் ப் ம் ய் ர் ல் வ் ழ் ள் ற் ன் ஆகிய 18 மெய் எழுத்துக்களும் அரை மாத்திரை பெற்று ஒலிக்கும்.</p>'
        ],
        'activities' => 
        [
          0 => 
      ...
      [
        ...
        'reading_pages' => [
          ...
          '<h2 class="text-primary text-center mb-4">1. குற்றியலுகரம்</h2><p>உகரம் தனியாக ஒலிக்கப்படும் போதும் தனிக்குறிலின் அடுத்து ஒலிக்கப்படும் போதும் 1 மாத்திரை பெறும். அவ்வாறு இல்லாமல் கு சு டு து பு று ஆகிய ஆறு எழுத்துக்களும் கீழ் வருவது போன்ற இடங்களில் அரை மாத்திரை அளவு பெற்று குற்றியலுகரமாக ஒலிக்கும்.</p>
          <div class="table-responsive"><table class="table table-bordered text-center align-middle" style="font-size: 0.9rem;">
            <thead class="bg-light"><tr><th>குற்றியலுகரம் வரும் இடங்கள்</th><th>சான்று</th></tr></thead>
            <tbody>
              <tr><td>நெடில்</td><td>பாகு, காசு, கூறு</td></tr>
              <tr><td>நெடில் + ஒற்று</td><td>பாக்கு, கூற்று, வாத்து</td></tr>
              <tr><td>குறிலிணை</td><td>இறகு, முரசு, மரபு</td></tr>
              <tr><td>குறிலிணை + ஒற்று</td><td>அரங்கு, மருந்து, சுழற்று</td></tr>
              <tr><td>குறில்நெடில்</td><td>அசோகு, இயைபு, கெடாது</td></tr>
              <tr><td>குறில்நெடில் + ஒற்று</td><td>அமைச்சு, நகைப்பு, நிலைத்து</td></tr>
              <tr><td>குறில் + ஒற்று</td><td>செக்கு, தச்சு, பத்து</td></tr>
            </tbody>
          </table></div>',
          '<h2 class="text-primary text-center mb-4">2. குற்றியலிகரம்</h2><p>குற்றியலுகரம் நிலைமொழியில் நிற்க வருமொழியில் யகரம் வந்தால் அது இகரமாகத் திரியும். அவ்வாறு திரியும் இகரம் குற்றியலிகரமாகி அரை மாத்திரை அளவு பெறும்.</p><p><strong>சான்று:</strong> காசு + யாது – காசியாது ( இங்கு சு என்ற குற்றியலுகரம் யா வருமொழியில் வந்ததால் சி என்று குற்றியலிகரம் ஆகியது. இந்த சி அரை மாத்திரை அளவு பெறும்.)</p>',
          '<h2 class="text-primary text-center mb-4">3. ஐகாரக் குறுக்கம்</h2><p>ஐகாரம் தன்னைக் குறிக்கும் போதும் அளபெடுத்து வரும் போதும் இரண்டு மாத்திரை அளவு பெறும். அவ்வாறு இல்லாமல் ஒரு சொல்லின் முதலிலோ இடையிலோ கடைசியிலோ வரும் போது குறுகி ஒலிக்கும். இது ஐகாரக் குறுக்கம் எனப்படும்.</p>
          <div class="table-responsive"><table class="table table-bordered text-center align-middle" style="font-size: 0.9rem;">
            <thead class="bg-light"><tr><th>வருமிடம்</th><th>மாத்திரை அளவு</th><th>சான்று</th></tr></thead>
            <tbody>
              <tr><td>மொழி முதல்</td><td>ஒன்றரை</td><td>ஐப்பசி, வைகாசி</td></tr>
              <tr><td>மொழி இடை</td><td>ஒன்று</td><td>இடையன்</td></tr>
              <tr><td>மொழி கடை</td><td>ஒன்று</td><td>வாழை</td></tr>
            </tbody>
          </table></div>',
          '<h2 class="text-primary text-center mb-4">4. அளபெடை</h2><p>அளபெடை – உயிரளபெடை, ஒற்றளபெடை என்று இரண்டு வகைப்படும்.</p><h4>உயிரளபெடை</h4><p>உயிர் எழுத்துக்களில் உள்ள ஏழு நெட்டெழுத்துக்களும் அளபெடுக்கும். அதாவது இரண்டு மாத்திரை அளவில் இருந்து கூடி மூன்று மாத்திரை அளவாக ஒலிக்கும். அவ்வாறு அளபெடுத்ததைக் காட்ட அடையாளமாக அந்தந்த நெட்டெழுத்துக்களின் இனமாகிய குறில் எழுத்துக்கள் அருகில் நிற்கும்.</p><p>உயிரளபெடை தனிநிலை, சொல்லின் முதல், இடை, கடை என நான்கு இடங்களில் அளபெடுக்கும்.</p><ul><li>தனிநிலை அளபெடை – ஆஅ, ஈஇ, ஊஉ, ஏஎ, ஐஇ, ஓஒ, ஔஉ</li><li>முதல்நிலை அளபெடை – ஆஅரிடம், ஈஇரிலை, ஊஉரிடம்</li><li>இடைநிலை அளபெடை – படாஅகை, பரீஇயம், வளைஇயம்</li><li>கடைநிலை அளபெடை – கடாஅ, குரீஇ, கடைஇ</li></ul>',
          '<h2 class="text-primary text-center mb-4">4. அளபெடை (தொடர்ச்சி)</h2><h4>ஒற்றளபெடை</h4><p>ங் ஞ் ண் ந் ம் ன் வ் ய் ல் ள் என்னும் பத்து மெய் எழுத்துக்களும் குறிலின் கீழும் குறிலிணையின் கீழும் அளபெடுத்து வரும். ஒற்றுக்கள்(மெய்யெழுத்துக்கள்) தமக்கு உரிய அரை மாத்திரை அளவில் இருந்து கூடி 1 மாத்திரை அளவாக இந்த இடங்களில் ஒலிக்கும்.</p><p><strong>சான்று:</strong><br>ங் – மங்ங்கலம், அரங்ங்கம்<br>ஞ் – மஞ்ஞ்சு, முரஞ்ஞ்சு</p><p>இவ்வாறு சிறப்பாகச் சுட்டப்பட்ட எழுத்துக்கள் தேவையான சீரினை அமைக்க இயலாத போது உதவுவனவாக உள்ளன.</p>'
        ],
        'activities' => 
        [
          0 => 
